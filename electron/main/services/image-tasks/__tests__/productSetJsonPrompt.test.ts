...
describe('productSetJsonPrompt', () => {
  it('renders a compact natural-language main-image execution prompt', () => {
    ...
    expect(prompt).toContain('title plus optional subtitle/kicker to at most two rendered lines total');
    ...
    expect(prompt).toContain('a kicker/subtitle counts as one line');
