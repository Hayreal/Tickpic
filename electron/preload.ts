...
const desktopShell: DesktopBridgeApi = {
  ...
  copyImageToClipboard: (payload) => ipcRenderer.invoke(IPC_CHANNELS.storage.copyImageToClipboard, payload),
  openLocalImage: (payload) => ipcRenderer.invoke(IPC_CHANNELS.storage.openLocalImage, payload),
