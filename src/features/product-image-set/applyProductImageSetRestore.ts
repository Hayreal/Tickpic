...
export function applyProductImageSetRestore(task: TaskRecord): ProductImageSetRestoreState | null {
  ...
  return {
    ...
    productHandheldMode: resolveEnum(request.productHandheldMode, ['auto', 'handheld', 'not_handheld'], 'auto'),
    ...
    showProductByIndex: subTab === 'main'
      ? restoreMainShowProductByIndex(
