...
export const STICKER_VARIATION_DIRECTIONS = [
  ...
  },
  {
    value: 'reverse',
    label: '反转裂变',
    prompt: '允许变化：反转主辅色关系，或互换上下、左右视觉重心。必须保持：品类识别、白名单文案、可读性和标签边界。',
  },
  {
    value: 'geometry',
    label: '色块/矩形重组',
  ...
  },
  {
    value: 'layout',
    label: '排版打乱重组',
    prompt: '允许变化：重新安排白名单文字、图形和色块的位置与组合。必须保持：全部白名单内容、目标品牌、容量和清晰的信息层级。',
  },
  {
    value: 'background',
    label: '背景重组',
    prompt: '允许变化：仅调整标签内部背景的纹理、色块和功效氛围。必须保持：前景白名单文字、产品信息和无外部环境的规则。',
  },
  {
    value: 'fusion',
    label: '爆款融合',
    prompt: '允许变化：融合参考图中抽象的排版、配色和装饰规律。必须保持：目标品牌和白名单文案；不得复制其他品牌、产品或字面文字。',
  },
  {
    value: 'key-element',
    label: '重点元素替换',
    prompt: '允许变化：替换标题字体、标题容器、功效图或一个主要装饰元素。必须保持：其他版式区域、白名单文案、目标品牌和容量。',
  },
] as const;
